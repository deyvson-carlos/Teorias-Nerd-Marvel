...
<head>
    ...
    <title>Blog: Teorias Nerd/Teoria</title>
...
<!-- cabecalho -->
        ...
        <hgroup id="To">
            <h6 id="color">"Comente aqui á sua teoria nerd"</h6><br>
        </hgroup>
       </header>
</article>
</section>
...
<div class="contato">
 <h3>Formulario: Sua Teoria</h3>
 <form class="form" method="POST" action="./dadosteorias.php">
  <input class="field" name="name" placeholder="Nome">
  <input class="field" name="email" placeholder="E-mail">
  <textarea id="mensagem" class="field" name="message" placeholder="Digite sua Teoria aqui"></textarea>

  <button id="enviarT" type="button" class="btn btn-outline-primary">Enviar</button>
...
.field{
    padding: 10px;margin-bottom: 15px;border: 1px solid black;
