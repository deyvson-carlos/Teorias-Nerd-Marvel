...
<head>
    ...
    <title>Blog:Teorias Nerd/Equipe</title>
...
<!-- conteudo equipe -->
       <section id="corpo-equipe">
            <article id="noticia-principal">
             <header id="cabecalho-artigo">   
        <hgroup id="eu">
            <h2 id="e1">Equipe</h2><br>

        </hgroup>
       </header>

       <figure class="fotosEq">
        <h4 id="t0">Mais alto, mais longe, mais rápido… Mais! Toda a equipe compartilha o sentimento de continuar sonhando com o melhor e o executando. Como um veículo de comunicação, olhamos para o cenário cultural brasileiro e pretendemos concretizar um plano de informações e conteúdos sólidos, acessíveis, com o mais alto padrão de qualidade na informação e na proximidade com o público, não importa o quão duro esse trabalho seja.</h4><br>

       <img id="fotequip" src="../imagens/equipe/deyvsonfotos.png"/>
      <h5 id="d">Deyvson Carlos: Programador full stack e Criador de conteúdo</h5>
    </figure>

        </section>
      
    </section>
<!-- fim de conteudo equipe -->
</div>
